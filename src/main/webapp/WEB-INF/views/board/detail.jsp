...
<div class="container p-3">
  <div class="row header">
    ...
    <div class="sub"><span class="fs-1 font-dongle p-0 m-0">${post.writer}</span>
      <br>
      <span class="fs-6 font-dongle">${post.write_date}</span>
      <span class="fs-6 mx-3 mt-0 font-dongle">조회수 ${post.view_count}</span>
    </div>
  </div>
  ...
  <div class="footer text-end">
    ...
    <c:choose>
      <c:when test="${loginId == post.writer}">
        <a href="/delete.board?postNum=${post.freeBoard_seq}"><button id="deleteBtn"
                                                                class="font-dongle btn btn-outline-primary">삭제하기</button></a>
        <a href="/toModify.board?postNum=${post.freeBoard_seq}"><button id="modifyBtn"
  ...
  <div class="comments row pt-2">
    <form method="post" action="/insert.comment" id="writeForm" class="p-0 m-0">
      ...
      <div class="row m-0 p-0 pt-1">
        ...
        <input type="hidden" name="postNum" value="${post.freeBoard_seq}">
      </div>
    </form>
    <script>
        ...
        <div class="row">
          ...
          <c:if test="${loginId == comment.writerId}">
            ...
            <div class="col-6 text-end">
              ...
              <a
                      href="/delete.comment?commentNum=${comment.commentNum}&postNum=${post.freeBoard_seq}">
